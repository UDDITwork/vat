    ...
    <div className="relative w-full overflow-hidden bg-slate-50 dark:bg-[#050505] transition-colors duration-300">
      ...
      <nav className="fixed top-0 w-full z-[100] px-6 md:px-12 py-8 flex items-center justify-between mix-blend-difference text-gray-900 dark:text-white">
        <div className="flex items-center gap-2">
          <img src="/logo.jpg" alt="VATALIQUE" className="h-16 w-auto rounded-lg object-contain" />
        </div>
        <div className="hidden md:flex items-center gap-10">
          ...
          <ThemeToggle />
          <button className="px-6 py-2 border border-black/20 dark:border-white/20 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all">
            What we do ?
          </button>
        </div>
